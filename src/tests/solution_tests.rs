...
mod solution_tests {
    ...
    fn test_solution_new_basic() {
        let sol = Solution::new("int main(){}".to_owned(), &[0, 1, 2]);
    ...
    fn test_solution_should_fail_true() {
        ...
        let sol = Solution::new("src".to_owned(), &[0]);
    ...
    fn test_solution_should_fail_false() {
        let sol = Solution::new("src".to_owned(), &[0, 2]);
    ...
    fn test_solution_should_fail_empty_pass_list() {
        ...
        let sol = Solution::new("src".to_owned(), &[]);
        for i in 0..10 {
    ...
    fn test_solution_passes_all_subtasks() {
        let sol = Solution::new("src".to_owned(), &[0, 1, 2, 3, 4]);
        for i in 0..5 {
            assert!(!sol.should_fail(i));
        }
    ...
    fn test_solution_source_stored() {
        ...
        let sol = Solution::new(src.clone(), &[0]);
    ...
    fn test_solution_duplicate_subtask_indices() {
        ...
        let sol = Solution::new("src".to_owned(), &[1, 1, 1]);
        assert!(!sol.should_fail(1));
