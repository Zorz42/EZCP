...
mod partial_solution_tests {
    ...
    fn test_partial_solution() {
        ...
        // Overflows `int` on the second subtask.
    ...
    fn test_partial_solution_crash() {
        ...
        task.task = task.task.with_subtask(subtask1).with_subtask(subtask2).with_partial_solution("partial", partial_solution_contents, &[]);
    ...
    fn test_partial_solution_that_is_never_broken_is_reported() {
        ...
        // Behaves exactly like the official solution.
        let partial_solution_contents = r#"
        #include <iostream>
        using namespace std;
        int main() {
